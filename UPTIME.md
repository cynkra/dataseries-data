...
_Last run: **2026-07-10T15:12:46Z**. Auto-generated by `R/uptime.R` (daily GitHub Action). Do not edit by hand._
...
- 🔴 **Run-through (upstream)** — 1 source(s) failed to fetch — **upstream did not deliver** (previous data kept). — **open incident: 2 day(s)**
