...
_Last run: **2026-07-11T08:57:35Z**. Auto-generated by `R/uptime.R` (daily GitHub Action). Do not edit by hand._
...
- `ch_adecco_sjmi` — Failed to perform HTTP request. Caused by error in `curl::curl_fetch_memory()`: ! Timeout was reached [www.stellenmarktmonitor.uzh.ch]: Failed to connect to www.stellenmarktmonitor.uzh.ch port 443 after 15001 ms: Timeout was reached **— escalated: 3 consecutive days, see `etl-outage` issue**
